...
| Models/evaluation | `test_model_profile_controls.py`, `test_evals.py`, `test_final_benchmark_readiness.py`, `test_eval_replication_contract.py`, v2 audit/metrics/runner/runtime-contract tests, v3 readiness and capability-conformance tests |
