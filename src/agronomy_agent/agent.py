...
GENERAL_ANSWER_OUTPUT_CONTRACT = (
    ...
    "For a field decision, start with what the current evidence supports, the practical next action, and only the missing evidence that could materially change the call. "
