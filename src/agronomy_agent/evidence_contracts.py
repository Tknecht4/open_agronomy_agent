...
def validated_answer_from_runtime(
    *,
    ...
    status = "legacy_verifier_pass" if verifier and not requires_review else "review_required"
    return ValidatedAnswer(
        ...
        validation_policy="legacy_text_verifier_adapter_no_claim_level_attestation",
        capture_status="answer_captured_claim_lineage_not_yet_validated",
    )
